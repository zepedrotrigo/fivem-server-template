		...
		if radar.shown  then
			if radar.freeze == false then
					...
					if IsEntityAVehicle(e) then
						...
						radar.info = string.format("~y~Matricula: ~w~%s ~y~Velocidade: ~w~%s kmh", fplate, math.ceil(fvspeed))
					end
					...
					if IsEntityAVehicle(j) then
						...
						radar.info2 = string.format("~y~Matricula: ~w~%s ~y~Velocidade: ~w~%s kmh", bplate, math.ceil(bvspeed))
			...
			DrawRect(0.313, 0.94, 0.2, 0.116, 0, 0, 0, 150)
			DrawAdvancedText(0.341, 0.903, 0.005, 0.0028, 0.4, "Radar Frontal", 0, 191, 255, 255, 6, 0)
			DrawAdvancedText(0.341, 0.953, 0.005, 0.0028, 0.4, "Radar Traseiro", 0, 191, 255, 255, 6, 0)
			DrawAdvancedText(0.41, 0.928, 0.005, 0.0028, 0.4, radar.info, 255, 255, 255, 255, 6, 0)
			DrawAdvancedText(0.41, 0.979, 0.005, 0.0028, 0.4, radar.info2, 255, 255, 255, 255, 6, 0)
