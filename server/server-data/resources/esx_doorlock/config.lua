...
Config.DoorList = {
	...
	{
		objHash = 190770132,
		objCoords = vector3(981.72, -102.72, 74.85),
		textCoords = vector3(981.72, -102.72, 74.85),
		authorizedJobs = {'mafiatwo'},
		locked = true,
		maxDistance = 3,
		size = 1
	},
...

	{
		...
		textCoords = vector3(113.9822, -1297.43, 29.41868),
		authorizedJobs = {'unicorn'},
		locked = true,
		maxDistance = 3,
		size = 1
...

	{
		...
		textCoords = vector3(-14.86892, -1441.182, 31.29323),
		authorizedJobs = { 'mafiaone' },
		locked = true,
		distance = 12,
		size = 2
	},
