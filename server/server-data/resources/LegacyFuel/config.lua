...
Config.Strings = {
	ExitVehicle = "Sai do veículo para abasteceres!",
	EToRefuel = "Pressiona ~g~E ~w~para abastecer o veículo",
	JerryCanEmpty = "Jerry Can vazio!",
	FullTank = "Depósito cheio!",
	PurchaseJerryCan = "Pressiona ~g~E ~w~para comprar um jerry can por ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Pressiona ~g~E ~w~para parares de abastecer",
	CancelFuelingJerryCan = "Pressiona ~g~E ~w~para parares de encher o jerry can",
	NotEnoughCash = "Não tens dinheiro suficiente!",
	RefillJerryCan = "Pressiona ~g~E ~w~ para encheres o jerry can ",
	NotEnoughCashJerryCan = "Não tens dinhiro suficiente para encher o jerry can!",
	JerryCanFull = "Jerry Can cheio!",
	TotalCost = "Preço",
}
