Locales['br'] = {
	...
	['exit_marker'] = 'Mentaliza ~INPUT_CONTEXT~ para cancelar o ~y~processo~s~',
	-- Blips
	['coke_field'] = 'Campo de Cocaína',
	['coke_processing'] = 'Processamento de cocaína',
	['coke_dealer'] = 'Negociante de cocaína',
	['meth_field'] = 'Campo de metanfetaminas',
	['meth_processing'] = 'Processamento de metanfetaminas',
	['meth_dealer'] = 'Distribuidor de metanfetaminas',
	['weed_field'] = 'Campo de erva',
	['weed_processing'] = 'processamento de erva',
	['weed_dealer'] = 'negociante de erva daninha',
	['opium_field'] = 'Campo de ópio',
	['opium_processing'] = 'processamento do ópio',
	['opium_dealer'] = 'negociante de ópio',
}