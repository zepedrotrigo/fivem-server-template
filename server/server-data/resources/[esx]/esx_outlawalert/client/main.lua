...
--fortnyce
		elseif IsPedShooting(playerPed) and not IsPedCurrentWeaponSilenced(playerPed) and Config.GunshotAlert and not ((GetSelectedPedWeapon(playerPed) == -1466123874) or (GetSelectedPedWeapon(playerPed) == 911657153)) then
			Citizen.Wait(3000)
