Locales['en'] = {
  ['mechanic']                  = 'Pound',
  ['drive_to_indicated']        = '~y~Conduz~s~ para a localização marcada no teu gps.',
  ['mission_canceled']          = '~r~Cancelaste~s~ a missão',
  ['vehicle_list']              = 'Lista de Veiculos',
  ['work_wear']                 = 'workwear',
  ...
  ['mechanic_customer']         = 'pound Customer',
