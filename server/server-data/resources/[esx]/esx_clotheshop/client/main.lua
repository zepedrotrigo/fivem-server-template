				...
				if CurrentAction == 'shop_menu' then
					...
					function(data, menu)
						...
						elseif data.current.value == 'change_cloth' then
							ESX.UI.Menu.CloseAll()
							ESX.TriggerServerCallback('fortnyce:getPlayerDressing', function(dressing)
								...
								function(data2, menu)
									...
									TriggerEvent('skinchanger:getSkin', function(skin)
										...
										ESX.TriggerServerCallback('fortnyce:getPlayerOutfit', function(clothes)
							...
							ESX.TriggerServerCallback('fortnyce:getPlayerDressing', function(dressing)
								...
								function(data2, menu)
									menu.close()
									TriggerServerEvent('fortnyce:removeOutfit', data2.current.value)
