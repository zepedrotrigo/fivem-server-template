...
ESX.RegisterServerCallback('fortnyce:getPlayerDressing', function(source, cb)
	local xPlayer  = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('fortnyce:getPlayerOutfit', function(source, cb, num)
	local xPlayer  = ESX.GetPlayerFromId(source)
...
RegisterNetEvent('fortnyce:removeOutfit')
AddEventHandler('fortnyce:removeOutfit', function(label)
	local xPlayer = ESX.GetPlayerFromId(source)
