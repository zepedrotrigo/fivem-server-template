		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, Keys['E']) then
				...
				elseif CurrentAction == 'Pharmacy' then
					OpenPharmacyMenu()
				elseif CurrentAction == 'Vehicles' then --fortnyce
					ESX.Game.SpawnVehicle('pt_inem4', vector3(290.41, -612.08, 43.39), 67.46, function(vehicle)
					local playerPed = PlayerPedId()
