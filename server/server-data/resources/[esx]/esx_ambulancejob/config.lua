...
Config.RespawnPoint = { coords = vector3(364.81, -581.05, 43.28), heading = 347.0 }
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(296.71, -583.94, 42.5),
			sprite = 61,
			scale  = 1.2,
			color  = 2
		},
		...
		AmbulanceActions = {
			vector3(306.84, -601.36, 42.35)
		},

		Pharmacies = {
			vector3(311.89, -597.0, 42.35)
		},

		Vehicles = {
			{
				Spawner = vector3(292.86, -601.23, 43.3),
				InsideShop = vector3(446.7, -1355.6, 43.5),
				Marker = { type = 36, x = 1.0, y = 1.0, z = 1.0, r = 100, g = 50, b = 200, a = 100, rotate = true },
				SpawnPoints = {
					{ coords = vector3(295.12, -609.84, 43.34), heading = 71.05, radius = 4.0 },
					{ coords = vector3(288.6, -612.17, 43.4), heading = 73.44, radius = 4.0 },
					{ coords = vector3(274.68, -605.89, 42.94), heading = 280.48, radius = 6.0 }
				}
			}
		},
