...
Citizen.CreateThread(function()
    ...
    if GUI.PhoneIsShowed then -- codes here: https://pastebin.com/guYd0ht4
      ...
      if IsDisabledControlJustReleased(0, 244) then -- MeleeAttackAlternate
          SendNUIMessage({
              type = "click"
          })
      end
      ...
      --if IsPedInAnyPoliceVehicle(GetPlayerPed(-1)) then
        if IsControlPressed(0, Keys['M']) and IsPedInAnyPoliceVehicle(GetPlayerPed(-1)) and (GetGameTimer() - GUI.Time) > 150 then
