		...
		if data.current.value == 'vehicle_list' then
			if Config.EnableSocietyOwnedVehicles then
				...
				local elements = {
					...
					{label = _U('tow_truck'), value = 'bison'},
					{label = 'BF400', value = 'bf400'},
					{label = 'atrelado', value = 'trailersmall'}
				}
...
function OpenMechanicCraftMenu()
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name == 'gay' then
		local elements = {
