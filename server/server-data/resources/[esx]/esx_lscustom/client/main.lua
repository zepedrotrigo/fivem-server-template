	...
	for k,v in pairs(Config.Menus) do
		...
		if data.value == k then
			...
			if v.modType then
				...
				if v.modType == 14 and PlayerData.job.name == "mechanic" then -- HORNS
					for j = 0, 51, 1 do
						local _label = ''
				...
				elseif v.modType == 'plateIndex' and PlayerData.job.name == "mechanic" then -- PLATES
					for j = 0, 4, 1 do
						local _label = ''
				...
				elseif v.modType == 22 and PlayerData.job.name == "mafiathree" then -- NEON
					local _label = ''
				...
				elseif (v.modType == 'neonColor' or v.modType == 'tyreSmokeColor') and PlayerData.job.name == "mafiathree"  then -- NEON & SMOKE COLOR
					print("YESII123")
				...
				elseif (v.modType == 'color1' or v.modType == 'color2' or v.modType == 'pearlescentColor' or v.modType == 'wheelColor') and PlayerData.job.name == "mechanic" then -- RESPRAYS
				...
				elseif v.modType == 'windowTint' and PlayerData.job.name == "mafiathree"  then -- WINDOWS TINT
					for j = 1, 5, 1 do
						local _label = ''
						if j == currentMods.modHorns then
				...
				elseif v.modType == 23 and PlayerData.job.name == "mechanic" then -- WHEELS RIM & TYPE
					local props = {}
				...
				elseif (v.modType == 11 or v.modType == 12 or v.modType == 13 or v.modType == 15 or v.modType == 16) and PlayerData.job.name == "mechanic" then
				...
				elseif v.modType == 17 and PlayerData.job.name == "mafiathree" then -- TURBO
					local _label = ''
...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			if (PlayerData.job and (PlayerData.job.name == 'mechanic' or PlayerData.job.name == 'mafiathree')) or not Config.IsMechanicJobOnly then -- fortnyce
				for k,v in pairs(Config.Zones) do
			...
			if IsControlJustReleased(0, 38) and not lsMenuIsShowed and isInLSMarker then
				if (PlayerData.job and PlayerData.job.name == 'mechanic' or PlayerData.job.name == 'mafiathree') or not Config.IsMechanicJobOnly then
					lsMenuIsShowed = true
