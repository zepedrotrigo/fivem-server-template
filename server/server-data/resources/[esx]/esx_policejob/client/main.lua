...
function OpenPoliceActionsMenu()
	...
	'default', GetCurrentResourceName(), 'police_actions',
	{
      ...
      {label = "Prender",               value = 'jail_menu'} -- You add this line
		}
	}, function(data, menu)
    ...
    if data.current.value == 'jail_menu' then
      TriggerEvent("esx-qalle-jail:openJailMenu")
        ...
        {label = 'Teste de resíduos de pólvora',			value = 'gsr_test'},
			}
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_policejob:getOtherPlayerData', function(data)
      ...
      if data.job.grade_label ~= nil and  data.job.grade_label ~= '' then
        ...
        local elements = {
          {label = 'Nome ' .. data.name, value = nil},
          {label = jobLabel,              value = nil},
        }
...
function OpenFineMenu(player)
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'fine',
    {
      ...
      align    = 'top-left',
      elements = {
        {label = 'Assassinatos',   value = 0},
        {label = 'Crimes Violentos',     value = 1},
        {label = 'Armas/Explosivos',   value = 2},
        {label = 'Drogas',     value = 3},
        {label = 'Corrupcao',     value = 4},
        {label = 'Crime com veiculos',     value = 5},
        {label = 'Outros crimes',     value = 6},
        {label = 'Outros delitos',     value = 7},
        {label = 'Transito',     value = 8},
        {label = 'Relativo a veiculos',     value = 9},
        {label = 'Violacao do veiculo',     value = 10},
