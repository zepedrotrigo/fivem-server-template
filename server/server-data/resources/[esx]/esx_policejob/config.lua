...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Helicopters = {
			{
				Spawner    = { x = 456.21, y = -987.81, z = 43.691 },
...
Config.AuthorizedVehicles = {
	Shared = {
		{
			model = 'police3',
			label = 'Carro de Patrulha'
		},
				{
			model = 'sultan',
			label = 'Carro à Paisana'
		},
		{
			model = 'sheriff2',
			label = 'Jipe Todo o Terreno'
		},
		--[[{
			model = 'riot',
			label = 'Blindado'
