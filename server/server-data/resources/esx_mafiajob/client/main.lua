...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    local elements = {
      ...
      {label = 'Tirar objeto',  value = 'get_stock'},
      {label = 'Guardar objeto',  value = 'put_stock'}
    }
          ...
          if Config.MaxInService == -1 then
            ...
            ESX.Game.SpawnVehicle(model, {
              ...
              if PlayerData.job.name == "mafia" then
                SetVehicleNumberPlateText(vehicle,"PEAKYB")
              elseif PlayerData.job.name == "mafiaone" then
                SetVehicleNumberPlateText(vehicle,"GROOVE")
              elseif PlayerData.job.name == "mafiathree" then
                SetVehicleNumberPlateText(vehicle,"RIVANS")
              else
                SetVehicleNumberPlateText(vehicle,"YAMAGU")
              end
            end)
...
AddEventHandler('esx_mafiajob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'mafia' or PlayerData.job.name == 'mafiaone' or PlayerData.job.name == 'mafiatwo' or PlayerData.job.name == 'mafiathree' or PlayerData.job.name == 'mafia4' or PlayerData.job.name == 'mafia5' or PlayerData.job.name == 'mafia6' or PlayerData.job.name == 'mafia7' or PlayerData.job.name == 'mafia8' or PlayerData.job.name == 'mafia9' or PlayerData.job.name == 'mafia10'  and not IsPedInAnyVehicle(playerPed, false) then
  ...
  while true do
    ...
    if PlayerData.job ~= nil and (PlayerData.job.name == 'mafia' or PlayerData.job.name == 'mafiaone' or PlayerData.job.name == 'mafiatwo' or PlayerData.job.name == 'mafiathree' or PlayerData.job.name == 'mafia4' or PlayerData.job.name == 'mafia5' or PlayerData.job.name == 'mafia6' or PlayerData.job.name == 'mafia7' or PlayerData.job.name == 'mafia8' or PlayerData.job.name == 'mafia9' or PlayerData.job.name == 'mafia10') then
      ...
      for k,v in pairs(Config.MafiaStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' or PlayerData.job.name == 'mafiaone' or PlayerData.job.name == 'mafiatwo' or PlayerData.job.name == 'mafiathree' or PlayerData.job.name == 'mafia4' or PlayerData.job.name == 'mafia5' or PlayerData.job.name == 'mafia6' or PlayerData.job.name == 'mafia7' or PlayerData.job.name == 'mafia8' or PlayerData.job.name == 'mafia9' or PlayerData.job.name == 'mafia10' and PlayerData.job.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' or PlayerData.job.name == 'mafiaone' or PlayerData.job.name == 'mafiatwo' or PlayerData.job.name == 'mafiathree' or PlayerData.job.name == 'mafia4' or PlayerData.job.name == 'mafia5' or PlayerData.job.name == 'mafia6' or PlayerData.job.name == 'mafia7' or PlayerData.job.name == 'mafia8' or PlayerData.job.name == 'mafia9' or PlayerData.job.name == 'mafia10' and (GetGameTimer() - GUI.Time) > 150 then
...
--[[
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and (PlayerData.job.name == 'mafia' or PlayerData.job.name == 'mafiaone' or PlayerData.job.name == 'mafiatwo' or PlayerData.job.name == 'mafiathree' or PlayerData.job.name == 'mafia4' or PlayerData.job.name == 'mafia5' or PlayerData.job.name == 'mafia6' or PlayerData.job.name == 'mafia7' or PlayerData.job.name == 'mafia8' or PlayerData.job.name == 'mafia9' or PlayerData.job.name == 'mafia10') and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
