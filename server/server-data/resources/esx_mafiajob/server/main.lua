...
TriggerEvent('esx_society:registerSociety', 'mafia', 'Peaky Blinders', 'society_mafia', 'society_mafia', 'society_mafia', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafiaone', 'Groove', 'society_mafiaone', 'society_mafiaone', 'society_mafiaone', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafiatwo', 'Cartel', 'society_mafiatwo', 'society_mafiatwo', 'society_mafiatwo', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafiathree', 'RivanS', 'society_mafiathree', 'society_mafiathree', 'society_mafiathree', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafia4', 'Mafia', 'society_mafia4', 'society_mafia4', 'society_mafia4', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafia5', 'Mafia', 'society_mafia5', 'society_mafia5', 'society_mafia5', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafia6', 'Mafia', 'society_mafia6', 'society_mafia6', 'society_mafia6', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafia7', 'Mafia', 'society_mafia7', 'society_mafia7', 'society_mafia7', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafia8', 'Mafia', 'society_mafia8', 'society_mafia8', 'society_mafia8', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafia9', 'Mafia', 'society_mafia9', 'society_mafia9', 'society_mafia9', {type = 'public'})
TriggerEvent('esx_society:registerSociety', 'mafia10', 'Mafia', 'society_mafia10', 'society_mafia10', 'society_mafia10', {type = 'public'})
