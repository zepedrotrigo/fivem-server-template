            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    labels = {"Cancelar", "Não", "Aplaudir", "Palmas Lentas", "Cruzar Braços", "Encostar"},
                ...
                },
                {
                    ...
                    labels = {"Continência", "Dedo do meio", "Paz", "Oh Não", "Merda", "Falhanço", "Morto", "GANG1", "GANG2", "Mãos cintura", "Mão na Arma", "Calma"},
